$(function () {
            ...
            markPoint: {
                ...
                label: {
                    normal: {
                        show: true,
                        position: 'left',
                        formatter: myRegression1.expression,
                        textStyle: {
                            color: '#333',
                            fontSize: 14
                        }
    ...
    var myRegression2 = ecStat.regression('linear', data2);
    ...
    var option2 = {
        ...
        series: [{
            ...
            markPoint: {
                ...
                data: [{
                    coord: myRegression1.points[myRegression2.points.length - 1]
                }]
            }
        }]
    };
    ...
    layui.use('form', function () {
        ...
        form.on('select(MES)', function (data) {
            if (data.value === 'Manual setting') {
                $(".ems_form").show(300)
            } else {
                $(".ems_form").hide(300)
        ...
        form.on('select(charts)', function (data) {
            // if (data.value === 'Manual setting') {
            //     $(".ems_form").show(300)
            // } else {
            //     $(".ems_form").hide(300)
    ...
    $(".means").on("click", function () {
        ...
        myChart.setOption(option1);
        var myChart = echarts.init(document.getElementById('means2'));
        myChart.setOption(option2);
    })
